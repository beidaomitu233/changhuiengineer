  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="navid" label="分类">
        <uni-data-picker v-model="formData.navid" collection="xzs_product_nav" field="_id as value, classname as text"></uni-data-picker>
      </uni-forms-item>
      <uni-forms-item name="picurl" label="产品图">
      ...
      <uni-forms-item name="grade" label="等级">
        <uni-easyinput placeholder="如：LM-2020060" v-model="formData.grade" trim="both"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="pronum" label="型号">
        <uni-easyinput placeholder="如：LM-2020060" v-model="formData.pronum" trim="both"></uni-easyinput>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("title,navid,picurl,orderid,grade,price,pronum,weight,year,checked").get().then((res) => {
