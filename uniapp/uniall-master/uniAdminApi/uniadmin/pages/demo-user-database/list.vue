<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="username,tel,gender,avatar" :where="where" page-data="replace"
        :orderby="orderby" :getcount="true" :page-size="options.pageSize" :page-current="options.pageCurrent"
        v-slot:default="{data,pagination,loading,error,options}" :options="options" loadtime="manual" @load="onqueryload">
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'username')" sortable @sort-change="sortChange($event, 'username')">姓名</uni-th>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'tel')" sortable @sort-change="sortChange($event, 'tel')">手机</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/demo-user-database.js';
  ...
  export default {
    data() {
      return {
        collectionList: "demo-user-database",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "demo-user-database.xls",
          "type": "xls",
          "fields": {
            "姓名": "username",
            "手机": "tel",
